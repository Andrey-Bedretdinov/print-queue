...
Начиная с версии 1.11.0 приложение обновляется само. Оно раз в несколько часов заглядывает в Releases, скачивает новую сборку в фоне и показывает уведомление «Готово обновление» с кнопкой **«Перезапустить и обновить»**. Момент выбираете вы: пока кнопку не нажали, ничего не меняется, а установка пройдёт при обычном закрытии окна. Настройки, скрытые принтеры и история сбоев при этом остаются на месте.
