...
- **Свой порядок.** Колонки переставляются перетаскиванием за заголовок, лишние принтеры прячутся чекбоксами в списке — порядок и скрытые запоминаются.
- **Прокрутка.** Колесо мыши листает доску по горизонтали; если очередь под курсором длиннее экрана, колесо сначала листает её.
