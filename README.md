...
Переносить можно задания, которые **ждут своей очереди**. То, что уже печатается, перенести нельзя: спулер отдал данные принтеру и стёр их с диска, хотя задание ещё висит в списке минуты. Такие строки в окне не тащатся и подписаны соответственно.
